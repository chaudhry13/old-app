  ...
  loginDevice(): Promise<any> {
    return this.oauthService.createAndSaveNonce().then(nonce => {
      ...
      return new Promise((resolve, reject) => {
        ...
        const browser = this.inAppBrowser.create(oauthUrl, "_blank", "usewkwebview=yes,location=no,clearsessioncache=yes,clearcache=yes,disallowoverscroll=yes,hardwareback=no,toolbar=no,footer=no");
