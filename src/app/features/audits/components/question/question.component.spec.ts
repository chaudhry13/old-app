...
describe("QuestionComponent", () => {
  ...
  beforeEach(async(() => {
    ...
    questionnaireHelperService = jasmine.createSpyObj(
      "QuestionnaireHelperService",
      [
        "findQuestionAnswer",
        "getQuestionAnswer",
    ...
    questionAnsweredService = jasmine.createSpyObj("QuestionAnsweredService", [
      "insert",
      "update",
      "get",
    ]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        {
          provide: QuestionnaireHelperService,
          useValue: questionnaireHelperService,
        },
