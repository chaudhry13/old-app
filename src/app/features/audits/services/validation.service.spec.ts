...
describe("ValidationService", () => {
  ...
  describe("Validation of questions", () => {
    ...
    it("and return false for empty answer", () => {
      ...
      expect(
        validationService.isQuestionAnswerValid(question, answerForm).isValid
      ).toBeFalsy();
    });
    ...
    it("and return true for valid answer", () => {
      ...
      expect(
        validationService.isQuestionAnswerValid(requiredQuestion, answerForm)
          .isValid
      ).toBeTruthy();
    });
    ...
    it("and return false for invalid answer and give correct error message", () => {
      ...
      answerForm.controls.text.markAsTouched();
      let validation = validationService.isQuestionAnswerValid(
        requiredQuestion,
        answerForm
      );
