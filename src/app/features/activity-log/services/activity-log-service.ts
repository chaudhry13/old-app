...
export class ActivityLogService extends GenericService {
  ...
  public getDivisionsWithManagers(): Promise<Division[]> {
    return this.http
      .post<Division[]>(this.apiBase + "/getdivisions?withManagers=true", {
        withManagers: true,
      })
      .toPromise();
  }
  ...
  public getActivityGuid(): Promise<string> {
    return this.http
      .get<string>(this.apiBase + "/activity/generate-guid")
      .toPromise();
  }

  public createActivity(activityData: FormGroup): Promise<string> {
    return this.http
      .post<string>(this.apiBase + "/activity", activityData.value)
      .toPromise();
  }

  public getActivityTypes(): Promise<ActivityType[]> {
    return this.http
      .get<ActivityType[]>(this.apiBase + "/activity/activity-types")
      .toPromise();
  }
}
